...
Github de maneira aberta e colaborativa.
...
As maratonas de programação da ACM aceitam C, C++, Java, Python e Kotlin. Mas eu
recomendo que se domine C++ e Python. C++ é a linguagem padrão para
...
Por isso a CCCP documentará dicas para C++ e Python. Ambas as linguagens possuem
vasta documentação na internet e é fácil encontrar soluções para problemas de
competições de programação escritas nessas linguagens.
